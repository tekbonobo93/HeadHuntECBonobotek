...
app.post("/api/jobs/daily-recommendation", async (req, res) => {
  if (!checkApiKey(res)) return;
...
app.post("/api/jobs/salary-comparison", async (req, res) => {
  if (!checkApiKey(res)) return;
...
app.post("/api/jobs/linkedin-import", async (req, res) => {
...
app.post("/api/goals/quiz", async (req, res) => {
  if (!checkApiKey(res)) return;
